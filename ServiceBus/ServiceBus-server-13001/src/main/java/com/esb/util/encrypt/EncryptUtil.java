...
public class EncryptUtil {
	...
	public static String getDecrypt(String cipher, String key){
		...
		key = RSA.decryptByPrivate(key, Constant.Constant_PRIVATE_KEY);
	...
	public static String getDecryptKey(String key){
		return RSA.decryptByPrivate(key, Constant.Constant_PRIVATE_KEY);
	}
	...
	public static Map<String, Object> getEncrypt(String data){
		...
		key = RSA.encryptByPublic(key, Constant.Constant_PUBLIC_KEY);
	...
	public static String getEncryptKey(String key) {
		return RSA.encryptByPublic(key, Constant.Constant_PUBLIC_KEY);
	}
